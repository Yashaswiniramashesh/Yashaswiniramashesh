...
- ⚡ **Inference at scale** - serving and evaluating models efficiently using vLLM and SGLang,
...
- 🧠 Focused on **RAG and agentic systems**, **SOTA model development**, **RL for LLM agents**, **synthetic data generation**, and **LLM evaluation** — teaching models to work in terminals, then grading their homework with other models
